<?
class Basket
{public function SetOrder($client)
	{$name=htmlspecialchars(strip_tags($client['name']);
	 $tel = htmlspecialchars(strip_tags($client['tel']));
        $address = htmlspecialchars(strip_tags($client['address']));
        $email = htmlspecialchars(strip_tags($client['email']));
